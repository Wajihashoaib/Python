...
# """
# Exercise 2
# Ask a Question to person about his name and favorite color.
# Then print msg like 'wajiya loves white'
# """
...
# operations, functions, and modifiers
# to format the value."""

#string methods in python
# course = 'python for beginners'
# print(len(course)) #return the length of the string
